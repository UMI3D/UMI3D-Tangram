...
namespace umi3d.edk
{
    ...
    public class UMI3DAvatarBone 
    {
        ...
        public static UMI3DAvatarBone GetUserBoneByIds(string userId, string boneId)
        {
            if (instancesByUserId.TryGetValue(userId, out Dictionary<string, UMI3DAvatarBone> skeleton))
            {
                if (skeleton.TryGetValue(boneId, out UMI3DAvatarBone bone))
                {
                    return bone;
